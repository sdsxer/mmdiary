...
package com.sdsxer.mmdiary.addedittask.domain.usecase;
...
import com.sdsxer.mmdiary.addedittask.domain.usecase.DeleteTask.RequestValues;
import com.sdsxer.mmdiary.addedittask.domain.usecase.DeleteTask.ResponseValue;
 ...
 */
public class DeleteTask extends UseCase<RequestValues, ResponseValue> {
