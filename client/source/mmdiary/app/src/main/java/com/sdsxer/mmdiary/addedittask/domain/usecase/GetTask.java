...
import com.sdsxer.mmdiary.addedittask.domain.usecase.GetTask.RequestValues;
import com.sdsxer.mmdiary.addedittask.domain.usecase.GetTask.ResponseValue;

/**
 * Retrieves a {@link Task} from the {@link TasksRepository}.
 */
public class GetTask extends UseCase<RequestValues, ResponseValue> {
