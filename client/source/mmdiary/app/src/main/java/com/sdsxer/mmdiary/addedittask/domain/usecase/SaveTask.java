...
import com.sdsxer.mmdiary.addedittask.domain.usecase.SaveTask.RequestValues;
import com.sdsxer.mmdiary.addedittask.domain.usecase.SaveTask.ResponseValue;
 ...
 */
public class SaveTask extends UseCase<RequestValues, ResponseValue> {
