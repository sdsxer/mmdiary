package com.sdsxer.mmdiary.statistics.domain.usecase;

import android.support.annotation.NonNull;

import com.sdsxer.mmdiary.UseCase;
import com.sdsxer.mmdiary.tasks.domain.model.Task;
import com.sdsxer.mmdiary.data.source.TasksDataSource;
import com.sdsxer.mmdiary.data.source.TasksRepository;
import com.sdsxer.mmdiary.statistics.domain.model.Statistics;

import com.sdsxer.mmdiary.statistics.domain.usecase.GetStatistics.RequestValues;
import com.sdsxer.mmdiary.statistics.domain.usecase.GetStatistics.ResponseValue;
 ...
 */
public class GetStatistics extends UseCase<RequestValues, ResponseValue> {
